      ...
      <div className="section">
        <div className="frame-1">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/04/cat-04-choice_01.png"
                alt="เจมีไนน์ นรวิชญ์"
              />
            </div>
            <h2>เจมีไนน์ นรวิชญ์</h2>
          </div>
        ...
        <div className="frame-2">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/04/cat-04-choice_02.png"
                alt="โฟร์ท ณัฐวรรธน์"
              />
            </div>
            <h2>โฟร์ท ณัฐวรรธน์</h2>
          </div>
        ...
        <div className="frame-3">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/04/cat-04-choice_03.png"
                alt="ริว วชิรวิชญ์"
              />
            </div>
            <h2>ริว วชิรวิชญ์</h2>
        ...
        <div className="frame-4">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/04/cat-04-choice_04.png"
                alt="มิว ศุภศิษฏ์"
              />
            </div>
            <h2>มิว ศุภศิษฏ์</h2>
        ...
        <div className="frame-2">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/04/cat-04-choice_05.png"
                alt="มาร์ค ภาคิน"
              />
            </div>
            <h2>มาร์ค ภาคิน</h2>
        ...
        <div className="frame-1">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/04/cat-04-choice_06.png"
                alt="ต้าห์อู๋ พิทยา"
              />
            </div>
            <h2>ต้าห์อู๋ พิทยา</h2>
          </div>
          <div className="section-2">
            <h2>ต้าห์อู๋ พิทยา</h2>
            <div className="btn">
...
const Malerisingstar = styled.div`
  margin: auto;
  max-width: 1300px;
