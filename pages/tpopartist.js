      ...
      <div className="section">
        <div className="frame-1">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/13/cat-13-choice_01.png"
                alt="PiXXiE"
              />
            </div>
            <h2>PiXXiE</h2>
        ...
        <div className="frame-2">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/13/cat-13-choice_02.png"
                alt="4EVE"
              />
            </div>
            <h2>4EVE</h2>
        ...
        <div className="frame-3">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/13/cat-13-choice_03.png"
                alt="PROXIE"
              />
            </div>
            <h2>PROXIE</h2>
        ...
        <div className="frame-4">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/13/cat-13-choice_04.png"
                alt="TRINITY"
              />
            </div>
            <h2>TRINITY</h2>
        ...
        <div className="frame-2">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/13/cat-13-choice_05.png"
                alt="ATLAS"
              />
            </div>
            <h2>ATLAS</h2>
        ...
        <div className="frame-1">
          <div className="section-1">
            <div className="block">
              <img
                src="https://s.isanook.com/an/0/topoftheyear/static/image/2023/choice/13/cat-13-choice_06.png"
                alt="LYKN"
              />
            </div>
            <h2>LYKN</h2>
